...
import com.aitest.springbootinit.model.dto.app.AppAddRequest;
import com.aitest.springbootinit.model.dto.app.AppEditRequest;
import com.aitest.springbootinit.model.dto.app.AppQueryRequest;
import com.aitest.springbootinit.model.dto.app.AppUpdateRequest;
...
public class AppController {
    ...
    public BaseResponse<Long> addApp(@RequestBody AppAddRequest appAddRequest, HttpServletRequest request) {
        ...
        // 在此处将实体类和 DTO 进行转换  减少重复代码、降低错误风险
        App app = new App();
